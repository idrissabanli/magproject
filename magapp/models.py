...
class Comments(models.Model):
    usercomment=models.ManyToManyField(User,related_name='comments' )
    reply_comment=models.ForeignKey('self',on_delete=models.CASCADE, related_name='replycomments')
    question=models.ForeignKey(Question,on_delete=models.CASCADE, related_name='replycomments')
